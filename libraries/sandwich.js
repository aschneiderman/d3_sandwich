...
function updatePreCodes(toyID)  {
  // updatePreCodes: read the values the user put in the toy's form
  //  and then use them to update the toy's pre code
    getFormInputValues(toyID).forEach(function(d, i) {
